...
ARG SYSTEM
ARG API_URL
ARG REVIEW_ENVIRONMENT
ARG MERGE_REQUEST_IID
ARG MERGE_REQUEST_TITLE
ARG MERGE_REQUEST_URL
...
ENV VITE_REVIEW_ENVIRONMENT=$REVIEW_ENVIRONMENT
ENV VITE_MERGE_REQUEST_IID=$MERGE_REQUEST_IID
ENV VITE_MERGE_REQUEST_TITLE=$MERGE_REQUEST_TITLE
ENV VITE_MERGE_REQUEST_URL=$MERGE_REQUEST_URL
