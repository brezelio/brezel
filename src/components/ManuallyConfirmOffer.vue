            ...
            <div>
               <table class="noborder" style="font-size: 10pt;width: 100%">
                  <tr>
                     ...
                     <td class="number-td"><b>He</b></td>
                  </tr>

                  <tr>
                     <td>Projektnummer</td>
                     <td class="number-td"><b>de</b></td>
                  </tr>
...
<script>
import { Api } from '@kibro/brezel-spa'
// import Api from 'api'
